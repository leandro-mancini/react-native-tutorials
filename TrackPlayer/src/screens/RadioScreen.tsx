...
export default function RadioScreen({ route }: NativeStackScreenProps<RootStackParamList, "Radio">) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        {picture ? <Image source={{ uri: picture }} style={styles.hero} /> : <View style={[styles.hero, styles.heroPh]} />}
