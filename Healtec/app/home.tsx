...
const favorites = [
  {
    ...
    reviews: "120",
    isFavorite: true,
    aboutMe: "Sou um cardiologista apaixonado por ajudar meus pacientes a manterem um coração saudável. Com mais de 10 anos de experiência, acredito que a escuta atenta e o cuidado contínuo são fundamentais para um tratamento eficaz. Atuo com foco em prevenção, diagnóstico e tratamento de doenças cardiovasculares, sempre com empatia e clareza na comunicação.",
  ...
  },
  {
    ...
    reviews: "97",
    isFavorite: true,
    aboutMe: "Sou especialista em dermatologia clínica e estética. Tenho como objetivo promover a saúde da pele e elevar a autoestima dos meus pacientes através de tratamentos modernos e humanizados. Acredito no atendimento personalizado, respeitando a individualidade de cada pessoa e buscando sempre os melhores resultados com segurança.",
  ...
  },
  {
    ...
    reviews: "143",
    isFavorite: true,
    aboutMe: "Como pediatra há mais de 12 anos, minha missão é garantir o bem-estar e desenvolvimento saudável das crianças, sempre com atenção, paciência e um sorriso acolhedor para os pequenos e seus familiares. Acompanho o crescimento infantil com foco em prevenção, vacinação e orientações completas para os pais.",
  ...
  },
  {
    ...
    reviews: "110",
    isFavorite: true,
    aboutMe: "Trabalho com foco na prevenção e tratamento de doenças neurológicas. Acredito na combinação entre conhecimento técnico, escuta ativa e empatia como base para um atendimento de excelência. Estou em constante atualização para oferecer diagnósticos precisos e tratamentos inovadores aos meus pacientes.",
  ...
  },
  {
    ...
    reviews: "85",
    isFavorite: true,
    aboutMe: "Sou ortopedista com experiência em lesões esportivas e reabilitação funcional. Meu compromisso é oferecer tratamentos que devolvam mobilidade, conforto e qualidade de vida aos meus pacientes. Atendo desde atletas de alta performance até pessoas com limitações no dia a dia, sempre com foco em soluções individualizadas.",
...
const topDoctors = [
  {
    ...
    rating: "4.9",
    isFavorite: false,
    aboutMe: "Sou ginecologista especializada em saúde da mulher. Acompanho minhas pacientes com cuidado e escuta ativa, oferecendo um atendimento acolhedor e baseado em evidências para cada fase da vida feminina. Tenho paixão por orientar e acompanhar desde a adolescência até o climatério, prezando sempre pelo respeito e empatia.",
  ...
  },
  {
    ...
    rating: "4.7",
    isFavorite: false,
    aboutMe: "Tenho mais de 10 anos de experiência em oftalmologia, atuando com foco na prevenção e tratamento de doenças oculares. A visão é um dos sentidos mais preciosos, e meu papel é cuidar dela com dedicação e precisão. Busco oferecer diagnósticos detalhados e soluções tecnológicas modernas para cada paciente.",
  ...
  },
  {
    ...
    rating: "4.6",
    isFavorite: false,
    aboutMe: "Sou urologista e busco proporcionar um atendimento humano e ético, focado no bem-estar dos meus pacientes. A saúde urinária e reprodutiva é essencial e merece atenção especializada. Valorizo o diálogo aberto, o respeito e o acompanhamento contínuo em todas as fases do tratamento.",
...
export const HomeScreen = () => {
    ...
    return (
        <View style={styles.container}>
          ...
          <Animated.View style={[styles.animatedHeader, { height: headerHeight, boxShadow: "0 3 30 0 rgba(16,16,16,0.3)" }]}>
            <AppBar
